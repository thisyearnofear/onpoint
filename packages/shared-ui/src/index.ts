// Export all UI components from the shared package
// NOTE: FashionCard is consolidated into CardEnhanced with variant='basic'
export { CardEnhanced as FashionCard } from './components/CardEnhanced'; // Legacy alias
export { CardEnhanced } from './components/CardEnhanced';
