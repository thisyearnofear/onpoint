...
export function PersonaCard({
  ...
  const personaConfig = {
    luxury: {
      title: "Anna Karenina",
      description: "Russian aristocratic fashion with refined and dramatic 19th-century high society style",
      icon: Crown,
      color: "text-amber-600",
      bgColor: "bg-amber-600/10",
      ringColor: "ring-amber-600",
      buttonBg: "bg-amber-600 hover:bg-amber-600/90",
      greeting: "Greetings! I am Anna Karenina, of the esteemed Karenin family. Allow me to guide you in the art of refined dressing befitting the highest echelons of society.",
      expertise: ["Haute couture", "Victorian elegance", "Luxurious fabrics", "Aristocratic style"],
    },
    streetwear: {
      title: "Artful Dodger",
      description: "Quintessential street-smart youth with gritty urban style and sneakerhead expertise",
      icon: Zap,
      color: "text-blue-600",
      bgColor: "bg-blue-600/10",
      ringColor: "ring-blue-600",
      buttonBg: "bg-blue-600 hover:bg-blue-600/90",
      greeting: "Wot cheer, mate! I'm the Artful Dodger, and I know every trick in the book when it comes to street fashion. Let's find you some proper gear!",
      expertise: ["Urban fashion", "Sneaker culture", "Street-smart style", "Hustler aesthetics"],
    },
    sustainable: {
      title: "Mowgli",
      description: "Jungle survivor representing coexistence with animals and ecological balance",
      icon: Leaf,
      color: "text-emerald-600",
      bgColor: "bg-emerald-600/10",
      ringColor: "ring-emerald-600",
      buttonBg: "bg-emerald-600 hover:bg-emerald-600/90",
      greeting: "Baloo taught me the bare necessities of life, and now I'm here to teach you about living in harmony with nature through sustainable fashion choices.",
      expertise: ["Natural materials", "Animal-friendly fashion", "Eco-conscious style", "Survival wear"],
    },
    edina: {
      title: "Edina Monsoon",
