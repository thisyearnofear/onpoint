    ...
    >
      <div className="bg-background/95 backdrop-blur-xl rounded-2xl border border-border shadow-2xl overflow-hidden">
        ...
        <div className="p-4">
            ...
            <div className="mb-3 p-2.5 rounded-xl bg-muted/30 border border-border/50">
              ...
              <div className="flex flex-wrap gap-1.5">
                ...
                {suggestion.observedFeatures.fit && (
                  <span className="px-2 py-0.5 rounded-full bg-success/20 text-emerald-300 text-[10px] font-medium">
                ...
                {suggestion.observedFeatures.style?.map((style, i) => (
                  <span
                    key={`style-${i}`}
                    className="px-2 py-0.5 rounded-full bg-warning/20 text-amber-300 text-[10px] font-medium"
                  >
                    {style}
                  </span>
                ))}
          ...
          {/* Search failed state */}
          {searchFailed && (
            <div className="mt-3 p-3 rounded-xl bg-error/5 border border-error/10">
              <div className="flex items-center gap-2">
          ...
          {suggestion.autoApprovable && (
            <div className="mt-3 flex items-center gap-2 text-xs text-emerald-400 bg-success/10 rounded-lg px-3 py-2">
