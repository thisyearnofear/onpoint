...
export default function CollagePage() {
  ...
  const [clothingDesign, setClothingDesign] =
    ...
    () => [
      {
        ...
        description:
          "High-fashion streetwear jacket with reflective material and bold geometric patterns",
      ...
      },
      {
        ...
        description:
          "Limited edition sneakers with unique color blocking and premium materials",
      ...
      },
      {
        ...
        description:
          "Bold accessories that complement the urban aesthetic with metallic finishes",
  ...
  const categories = [
    "all",
    ...Array.from(
      new Set(fashionLibrary.map((item) => item.category).filter(Boolean)),
    ),
  ];
        ...
        <div className="flex-1">
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
              Drag items from the library to build your collage, then use AI to
              generate custom garments and get expert feedback. Share your
          ...
          {(usageCount.generations >= 3 ||
            usageCount.critiques >= 3 ||
            usageCount.suggestions >= 3) && (
            <div className="bg-gradient-to-r from-primary/5 to-accent/5 border border-primary/20 rounded-lg p-4 mb-8 max-w-4xl mx-auto">
              ...
              <p className="text-sm text-muted-foreground">
                Try one more generation or critique for just $1.99. Unlock
                unlimited creativity with our premium features.
              </p>
            </div>
          )}
          ...
          {suggestions && (
            <div className="elegant-shadow border-0 rounded-lg bg-card p-6 mb-8 max-w-4xl mx-auto">
              ...
              <p className="text-sm text-muted-foreground mt-4">
                Refine your collage based on these suggestions, then generate a
                full garment or get a detailed critique.
              </p>
            </div>
          )}
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                  ...
                  <p className="text-muted-foreground mb-4">
                    {clothingDesign.description}
                  </p>

                  <h4 className="font-medium mb-2">Style Notes</h4>
                  <p className="text-muted-foreground">
                    {clothingDesign.styleNotes}
                  </p>
                </div>
          ...
          <div className="text-center">
            ...
            <p className="text-muted-foreground mb-6 max-w-2xl mx-auto">
              Once your collage is complete, generate custom garments or try
              them on in our interactive style lab.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center max-w-md mx-auto">
              <Button
                asChild
                className="fashion-gradient text-white px-6 py-3 h-auto min-h-[48px] text-base font-medium"
              >
                <Link
                  href="/style"
              ...
              <Button
                variant="outline"
                className="px-6 py-3 h-auto min-h-[48px] text-base font-medium border-primary text-primary hover:bg-primary hover:text-primary-foreground"
              >
